...
var NumberInput = (n2) => {
  var { value: a, onValueChange: l3 } = n2, o2 = e2(n2, ["value", "onValueChange"]);
  const [r, d2] = import_react3.default.useState(a.toString());
  return import_react3.default.useEffect(() => {
    d2(a.toString());
  }, [a]), import_react3.default.createElement(NumericInput, Object.assign({ value: r, onValueChange: (e20, t6) => {
...
var FiltersPicker = observer(({ element: e20, store: c2, elements: g5 }) => {
  const b3 = g5 || [e20], x2 = b3[0], E3 = "text" === x2.type, y2 = "image" === x2.type, f2 = "svg" === x2.type, v3 = y2 || f2, C2 = (e21) => {
  ...
  return import_react3.default.createElement(Popover, { content: import_react3.default.createElement("div", { style: { padding: "15px", paddingTop: "15px", width: "230px", maxHeight: "calc(100vh - 150px)", overflow: "auto" } }, import_react3.default.createElement(h, { label: t("toolbar.blur"), enabled: x2.blurEnabled, visible: v3 || E3, onEnabledChange: (e21) => {
    C2({ blurEnabled: e21 });
  }, numberValue: x2.blurRadius, onNumberValueChange: (e21) => {
    C2({ blurRadius: e21 });
  }, min: 0, max: 100 }), import_react3.default.createElement(h, { label: t("toolbar.brightness"), visible: v3, enabled: x2.brightnessEnabled, onEnabledChange: (e21) => {
    C2({ brightnessEnabled: e21 });
  }, numberValue: 100 * x2.brightness + 100, onNumberValueChange: (e21) => {
    C2({ brightness: (e21 - 100) / 100 });
  }, min: 0, max: 200 }), v3 && import_react3.default.createElement(Switch, { checked: x2.sepiaEnabled, label: t("toolbar.sepia"), onChange: (e21) => {
    C2({ sepiaEnabled: e21.target.checked });
  }, alignIndicator: Alignment.RIGHT, style: { marginTop: "20px" } }), v3 && import_react3.default.createElement(Switch, { checked: x2.grayscaleEnabled, label: t("toolbar.grayscale"), onChange: (e21) => {
    C2({ grayscaleEnabled: e21.target.checked });
  }, alignIndicator: Alignment.RIGHT, style: { marginTop: "20px" } }), E3 && import_react3.default.createElement(Switch, { checked: !!x2.strokeWidth, label: t("toolbar.textStroke"), onChange: (e21) => {
    C2({ strokeWidth: e21.target.checked ? 2 : 0 });
  }, alignIndicator: Alignment.RIGHT, style: { marginTop: "20px" } }), E3 && !!x2.strokeWidth && import_react3.default.createElement(import_react3.default.Fragment, null, import_react3.default.createElement("div", { style: { display: "flex", justifyContent: "space-between" } }, import_react3.default.createElement(color_picker_default, { value: x2.stroke, size: 30, onChange: (e21) => {
    C2({ stroke: e21 });
  }, store: c2 }), import_react3.default.createElement(NumericInput, { defaultValue: x2.strokeWidth, onValueChange: (e21) => {
    C2({ strokeWidth: p(e21, 1, 30) });
  }, style: { width: "80px" }, min: 1, max: Math.round(x2.fontSize / 2) }))), E3 && import_react3.default.createElement(Switch, { checked: !!x2.backgroundEnabled, label: t("toolbar.textBackground"), onChange: (e21) => {
    C2({ backgroundEnabled: e21.target.checked });
  }, alignIndicator: Alignment.RIGHT, style: { marginTop: "20px" } }), !!x2.backgroundEnabled && import_react3.default.createElement(import_react3.default.Fragment, null, import_react3.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", paddingTop: "5px", paddingBottom: "5px" } }, import_react3.default.createElement("div", null, t("toolbar.backgroundCornerRadius")), import_react3.default.createElement("div", null, import_react3.default.createElement(NumberInput, { value: 100 * x2.backgroundCornerRadius, onValueChange: (e21) => {
    C2({ backgroundCornerRadius: p(e21, 0, 100) / 100 });
  }, style: { width: "50px" }, min: 0, max: 100, buttonPosition: "none" }))), import_react3.default.createElement(Slider, { value: 100 * x2.backgroundCornerRadius, onChange: (e21) => {
    C2({ backgroundCornerRadius: p(e21, 0, 100) / 100 });
  }, min: 0, max: 100, labelRenderer: false }), import_react3.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", paddingTop: "5px", paddingBottom: "5px" } }, import_react3.default.createElement("div", null, t("toolbar.backgroundPadding")), import_react3.default.createElement("div", null, import_react3.default.createElement(NumberInput, { value: Math.round(100 * x2.backgroundPadding), onValueChange: (e21) => {
    C2({ backgroundPadding: p(e21, 0, 100) / 100 });
  }, style: { width: "50px" }, min: 0, max: 100, buttonPosition: "none" }))), import_react3.default.createElement(Slider, { value: Math.round(100 * x2.backgroundPadding), onChange: (e21) => {
    C2({ backgroundPadding: p(e21, 0, 100) / 100 });
  }, min: 0, max: 100, labelRenderer: false }), import_react3.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", paddingTop: "5px", paddingBottom: "5px" } }, import_react3.default.createElement("div", null, t("toolbar.opacity")), import_react3.default.createElement("div", null, import_react3.default.createElement(NumberInput, { value: Math.round(100 * x2.backgroundOpacity), onValueChange: (e21) => {
    C2({ backgroundOpacity: e21 / 100 });
  }, style: { width: "50px" }, min: 0, max: 100, buttonPosition: "none" }))), import_react3.default.createElement(Slider, { value: 100 * x2.backgroundOpacity, onChange: (e21) => {
    C2({ backgroundOpacity: e21 / 100 });
  }, min: 0, max: 100, labelRenderer: false }), import_react3.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", paddingTop: "5px", paddingBottom: "5px" } }, import_react3.default.createElement("div", { style: { lineHeight: "30px" } }, t("toolbar.color")), import_react3.default.createElement(color_picker_default, { value: x2.backgroundColor, size: 30, onChange: (e21) => {
    C2({ backgroundColor: e21 });
  }, store: c2 }))), v3 && import_react3.default.createElement(Switch, { checked: !!x2.borderSize, label: t("toolbar.border"), onChange: (e21) => {
    C2({ borderSize: e21.target.checked ? 2 : 0 });
  }, alignIndicator: Alignment.RIGHT, style: { marginTop: "20px" } }), !!x2.borderSize && import_react3.default.createElement(import_react3.default.Fragment, null, import_react3.default.createElement("div", { style: { display: "flex", justifyContent: "space-between" } }, import_react3.default.createElement(color_picker_default, { value: x2.borderColor, size: 30, onChange: (e21) => {
    C2({ borderColor: e21 });
  }, store: c2 }), import_react3.default.createElement(NumericInput, { defaultValue: x2.borderSize, onValueChange: (e21) => {
    C2({ borderSize: p(e21, 1, Math.min(x2.width, x2.height) / 2) });
  }, style: { width: "80px" }, min: 1, max: Math.max(1, Math.min(x2.width, x2.height) / 2) }))), v3 && import_react3.default.createElement(Switch, { checked: !!x2.cornerRadius, label: t("toolbar.cornerRadius"), onChange: (e21) => {
    C2({ cornerRadius: e21.target.checked ? Math.min(x2.width / 4, x2.height / 4) : 0 });
  }, alignIndicator: Alignment.RIGHT, style: { marginTop: "20px" } }), v3 && !!x2.cornerRadius && import_react3.default.createElement("div", { style: { display: "flex", width: "100%", justifyContent: "space-between" } }, import_react3.default.createElement("div", { style: { width: "150px", paddingTop: "7px" } }, import_react3.default.createElement(Slider, { value: Math.min(x2.cornerRadius, Math.round(Math.min(x2.width / 2, x2.height / 2))), onChange: (e21) => {
    C2({ cornerRadius: e21 });
  }, min: 1, max: Math.round(Math.min(x2.width / 2, x2.height / 2)), labelStepSize: 50, showTrackFill: false, labelRenderer: false })), import_react3.default.createElement(NumericInput, { value: x2.cornerRadius, onValueChange: (e21) => {
    C2({ cornerRadius: p(e21, 1, Math.min(x2.width, x2.height) / 2) });
  }, buttonPosition: "none", style: { width: "45px", padding: "0 5px" }, min: 1, max: Math.round(Math.min(x2.width / 2, x2.height / 2)) })), import_react3.default.createElement(Switch, { checked: x2.shadowEnabled, label: t("toolbar.shadow"), onChange: (e21) => {
    C2({ shadowEnabled: e21.target.checked });
  }, alignIndicator: Alignment.RIGHT, style: { marginTop: "20px" } }), x2.shadowEnabled && import_react3.default.createElement(import_react3.default.Fragment, null, import_react3.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", paddingTop: "5px", paddingBottom: "5px" } }, import_react3.default.createElement("div", null, t("toolbar.blur")), import_react3.default.createElement("div", null, import_react3.default.createElement(NumberInput, { value: x2.shadowBlur, onValueChange: (e21) => {
    C2({ shadowBlur: p(e21, -50, 50) });
  }, style: { width: "50px" }, min: 0, max: 50, buttonPosition: "none" }))), import_react3.default.createElement(Slider, { value: x2.shadowBlur, onChange: (e21) => {
    C2({ shadowBlur: e21 });
  }, min: 0, max: 50, showTrackFill: false, labelRenderer: false }), import_react3.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", paddingTop: "5px", paddingBottom: "5px" } }, import_react3.default.createElement("div", null, t("toolbar.offsetX")), import_react3.default.createElement("div", null, import_react3.default.createElement(NumberInput, { value: x2.shadowOffsetX, onValueChange: (e21) => {
    C2({ shadowOffsetX: p(e21, -50, 50) });
  }, style: { width: "50px" }, min: -50, max: 50, buttonPosition: "none" }))), import_react3.default.createElement(Slider, { value: x2.shadowOffsetX, onChange: (e21) => {
    C2({ shadowOffsetX: e21 });
  }, min: -50, max: 50, showTrackFill: false, labelRenderer: false }), import_react3.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", paddingTop: "5px", paddingBottom: "5px" } }, import_react3.default.createElement("div", null, t("toolbar.offsetY")), import_react3.default.createElement("div", null, import_react3.default.createElement(NumberInput, { value: x2.shadowOffsetY, onValueChange: (e21) => {
    C2({ shadowOffsetY: p(e21, -50, 50) });
  }, style: { width: "50px" }, min: -50, max: 50, buttonPosition: "none" }))), import_react3.default.createElement(Slider, { value: x2.shadowOffsetY, onChange: (e21) => {
    C2({ shadowOffsetY: e21 });
  }, min: -50, max: 50, showTrackFill: false, labelRenderer: false }), import_react3.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", paddingTop: "5px", paddingBottom: "5px" } }, import_react3.default.createElement("div", null, t("toolbar.opacity")), import_react3.default.createElement("div", null, import_react3.default.createElement(NumberInput, { value: Math.round(100 * x2.shadowOpacity), onValueChange: (e21) => {
    C2({ shadowOpacity: e21 / 100 });
  }, style: { width: "50px" }, min: 0, max: 100, buttonPosition: "none" }))), import_react3.default.createElement(Slider, { value: 100 * x2.shadowOpacity, onChange: (e21) => {
    C2({ shadowOpacity: e21 / 100 });
  }, min: 0, max: 100, labelRenderer: false }), import_react3.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", paddingTop: "5px", paddingBottom: "5px" } }, import_react3.default.createElement("div", { style: { lineHeight: "30px" } }, t("toolbar.color")), import_react3.default.createElement(color_picker_default, { value: x2.shadowColor, size: 30, onChange: (e21) => {
    C2({ shadowColor: e21 });
...
var AnimationsPickerOld = observer(({ element: e20, store: o2, elements: r }) => {
  ...
  return import_react4.default.createElement(Popover, { hasBackdrop: false, autoFocus: false, content: import_react4.default.createElement("div", { style: { padding: "15px", paddingTop: "25px", width: "230px" } }, import_react4.default.createElement(Switch, { checked: g5("fade"), label: t("toolbar.fade"), onChange: (e21) => {
    v3("fade", { enabled: e21.target.checked });
  }, alignIndicator: Alignment.RIGHT }), import_react4.default.createElement(Switch, { checked: g5("move"), label: t("toolbar.move"), onChange: (e21) => {
    v3("move", { enabled: e21.target.checked });
  }, alignIndicator: Alignment.RIGHT }), import_react4.default.createElement(Switch, { checked: g5("zoom"), label: t("toolbar.zoom"), onChange: (e21) => {
    v3("zoom", { enabled: e21.target.checked });
  }, alignIndicator: Alignment.RIGHT }), import_react4.default.createElement(b, { element: p3, store: o2, name: "move", enabled: g5() }), g5("move") && import_react4.default.createElement(h2, { value: (null === (d2 = null === (m2 = p3.animations.find((e21) => "move" === e21.name)) || void 0 === m2 ? void 0 : m2.data) || void 0 === d2 ? void 0 : d2.direction) || "right", onChange: (e21) => {
    v3("move", { data: { direction: e21 }, enabled: true });
  } }), g5() && import_react4.default.createElement(f, { store: o2, element: e20 }), g5() && import_react4.default.createElement(y, { store: o2, element: e20 }), import_react4.default.createElement(Switch, { checked: g5("rotate"), label: t("toolbar.rotate"), onChange: (e21) => {
    var t6;
...
var W2 = ["left", "center", "right", "justify"];
var N = ["top", "middle", "bottom"];
var O = { top: import_react6.default.createElement("span", { className: "bp5-icon" }, import_react6.default.createElement(import_MdcFormatVerticalAlignTop2.default, null)), middle: import_react6.default.createElement("span", { className: "bp5-icon" }, import_react6.default.createElement(import_MdcFormatVerticalAlignCenter2.default, null)), bottom: import_react6.default.createElement("span", { className: "bp5-icon" }, import_react6.default.createElement(import_MdcFormatVerticalAlignBottom2.default, null)) };
var B = observer(({ active: t6, globalActive: o2, format: l3, element: i, disableGlobal: r, enableGlobal: a, icon: c2 }) => import_react6.default.createElement(Button, { minimal: true, icon: c2, active: t6, onMouseDown: (e20) => {
  e20.preventDefault();
}, onClick: (e20) => {
  let t7 = window.__polotnoQuill;
  if (t7) {
    const e21 = t7.getSelection();
    return t7.formatText(e21.index, e21.length, l3, !quillRef.currentFormat[l3], "user"), void (o2 && r());
  }
  t7 = _2({ html: i.text }), t7.setSelection(0, t7.getLength(), "api"), t7.format(l3, false);
  const n2 = t7.root.innerHTML;
  L2(t7), i.set({ text: n2 }), o2 ? r() : a();
} }));
var TextBold = observer(({ element: t6, store: n2 }) => import_react6.default.createElement(B, { format: "bold", active: quillRef.currentFormat.bold || "bold" === t6.fontWeight || "700" === t6.fontWeight, globalActive: "bold" === t6.fontWeight || "700" === t6.fontWeight, element: t6, disableGlobal: () => t6.set({ fontWeight: "normal" }), enableGlobal: () => t6.set({ fontWeight: "bold" }), icon: import_react6.default.createElement(Bold, null) }));
var FontStyleGroup = observer(({ element: t6, store: l3, elements: d2, components: u2 }) => {
  const x2 = (null == u2 ? void 0 : u2.TextBold) || TextBold;
  return import_react6.default.createElement(ButtonGroup, null, import_react6.default.createElement(x2, { element: t6, store: l3 }), import_react6.default.createElement(B, { format: "italic", active: quillRef.currentFormat.italic || "italic" === t6.fontStyle, globalActive: "italic" === t6.fontStyle, element: t6, disableGlobal: () => t6.set({ fontStyle: "normal" }), enableGlobal: () => t6.set({ fontStyle: "italic" }), icon: import_react6.default.createElement(Italic, null) }), import_react6.default.createElement(B, { format: "underline", active: quillRef.currentFormat.underline || t6.textDecoration.indexOf("underline") >= 0, globalActive: t6.textDecoration.indexOf("underline") >= 0, element: t6, disableGlobal: () => {
  ...
  }, icon: import_react6.default.createElement(Underline, null) }), import_react6.default.createElement(B, { format: "strike", active: quillRef.currentFormat.strike || t6.textDecoration.indexOf("line-through") >= 0, globalActive: t6.textDecoration.indexOf("line-through") >= 0, element: t6, disableGlobal: () => {
    let e20 = t6.textDecoration.split(" ");
    ...
    const e20 = (W2.indexOf(t6.align) + 1 + W2.length) % W2.length, n2 = W2[e20];
    l3.history.transaction(() => {
      d2.forEach((e21) => {
        e21.set({ align: n2 });
      });
    });
  } }), flags.textVerticalResizeEnabled && import_react6.default.createElement(Button, { minimal: true, icon: O[t6.verticalAlign], onClick: () => {
    const e20 = (N.indexOf(t6.verticalAlign) + 1 + N.length) % N.length, n2 = N[e20];
    l3.history.transaction(() => {
      t6.set({ verticalAlign: n2 });
    });
    ...
    let e20 = window.__polotnoQuill, n2 = !e20;
    e20 = e20 || _2({ html: t6.text }), n2 && e20.setSelection(0, e20.getLength(), "api");
    const o2 = e20.getFormat();
    o2.list ? "bullet" === o2.list ? e20.format("list", "ordered") : e20.format("list", false) : e20.format("list", "bullet"), n2 && (t6.set({ text: e20.root.innerHTML }), L2(e20));
  } }));
});
var FontColorInput = observer(({ element: t6, store: n2 }) => {
  ...
  return import_react6.default.createElement(color_picker_default, { value: quillRef.currentFormat.color || t6.fill, gradientEnabled: true, onOpen: () => {
    ...
    if (!l4) {
      var i = t6.text.replace(/style=".*?"/g, "");
      return void t6.set({ fill: e20, text: i });
    }
    const r = (null == l4 ? void 0 : l4.length) >= (null == n3 ? void 0 : n3.getLength()) - 1;
    n3 && !r && (null == l4 ? void 0 : l4.length) ? n3.formatText(l4.index, l4.length, "color", e20, "user") : (i = t6.text.replace(/style=".*?"/g, ""), t6.set({ fill: e20, text: i }));
  }, store: n2 });
});
var DirectionInput = observer(({ element: t6 }) => {
  const o2 = "rtl" === t6.dir ? import_MdFormatTextdirectionRToL.default : import_MdFormatTextdirectionLToR.default;
  return import_react6.default.createElement(Button, { icon: import_react6.default.createElement(o2, { className: "bp5-icon", style: { fontSize: "20px" } }), minimal: true, onClick: () => {
    t6.set({ dir: "rtl" === t6.dir ? "ltr" : "rtl" });
  } });
});
var V = { TextFontFamily, TextFontSize, TextFontVariant: FontStyleGroup, TextTransform, TextFilters: filters_picker_default, TextFill: FontColorInput, TextSpacing, TextDirection: DirectionInput, TextAnimations: AnimationsPicker, TextAiWrite };
var HtmlToolbar = observer(({ store: t6, components: n2 }) => {
  const o2 = t6.selectedElements, l3 = t6.selectedElements[0], i = ["TextFill", "TextFontFamily", "TextFontSize", "TextFontVariant", "TextSpacing", "TextTransform", "TextFilters", flags.animationsEnabled && "TextAnimations", "TextAiWrite"], r = extendToolbar({ type: "text", usedItems: i, components: n2 });
  return import_react6.default.createElement(ElementContainer, { items: r, itemRender: (i2) => {
    if ("TextBold" === i2) {
      return null;
    }
    const r2 = n2[i2] || V[i2];
    return import_react6.default.createElement(r2, { element: l3, elements: o2, store: t6, key: i2, components: n2 });
  } });
});
...
var RemoveBackgroundDialog = observer(({ isOpen: t6, onClose: a, element: m2 }) => {
  ...
  const [u2, d2] = import_react8.default.useState(false), g5 = i !== m2.src;
  return import_react8.default.createElement(Dialog, { onClose: a, title: t("toolbar.removeBackgroundTitle"), isOpen: t6, style: { width: "80%", maxWidth: "700px" } }, import_react8.default.createElement("div", { className: classes_exports.DIALOG_BODY }, import_react8.default.createElement("img", { src: i, style: { width: "100%", maxHeight: "400px", objectFit: "contain" } })), import_react8.default.createElement("div", { className: classes_exports.DIALOG_FOOTER, style: { position: "relative" } }, import_react8.default.createElement("div", { className: classes_exports.DIALOG_FOOTER_ACTIONS }, !g5 && import_react8.default.createElement(Button, { onClick: async () => {
    d2(true);
    try {
      s3(await l(m2.src));
    } catch (e20) {
    ...
    d2(false);
  }, loading: u2 }, t("toolbar.removeBackground")), g5 && import_react8.default.createElement(import_react8.default.Fragment, null, import_react8.default.createElement(Button, { onClick: () => {
    s3(m2.src), a();
...
var I = { ImageFlip: flip_button_default, ImageFilters: filters_picker_default, ImageFitToBackground, ImageCrop, ImageClip, ImageRemoveBackground, ImageAnimations: AnimationsPicker };
var ImageToolbar = observer(({ store: t6, components: n2 }) => {
  ...
  const g5 = ["ImageFlip", "ImageFilters", "ImageFitToBackground", "ImageClip", "ImageCrop", flags.animationsEnabled && "ImageAnimations", flags.removeBackgroundEnabled && "ImageRemoveBackground"], d2 = extendToolbar({ type: "image", usedItems: g5, components: n2 });
...
var g3 = { SvgFlip: flip_button_default, SvgFilters: filters_picker_default, SvgColors: observer(({ element: t6, elements: o2, store: s3 }) => {
...
var VideoTrim = observer(({ store: t6, components: o2, element: i }) => {
  ...
  return import_react12.default.createElement(Popover, { position: "bottom", onOpened: async () => {
    ...
    const { width: e20, height: t7 } = await getVideoSize(i.src), o3 = e20 / t7, { src: n2 } = i, r = m2.current.offsetHeight, a = m2.current.offsetWidth, l3 = r * o3, s3 = Math.ceil(a / l3), g6 = await getVideoDuration(n2), v3 = document.createElement("video");
    ...
    try {
      ...
      for (let e21 = 0; e21 < s3; e21++) {
        const t8 = e21 * g6 / s3, o4 = await getVideoObjectPreview(v3, w2, t8);
...
var g4 = observer(({ store: e20 }) => e20.activePage ? import_react16.default.createElement(ColorPicker, { value: e20.activePage.background || "white", onChange: (t6) => {
...
var DownloadButton = observer(({ store: i }) => {
  const [p3, u2] = import_react17.default.useState(false);
  return import_react17.default.createElement(Popover, { content: import_react17.default.createElement(Menu, null, import_react17.default.createElement(MenuItem, { icon: import_react17.default.createElement(Media, null), text: t("toolbar.saveAsImage"), onClick: async () => {
    ...
    u2(true), await i.saveAsPDF(), u2(false);
  } })), position: Position.BOTTOM }, import_react17.default.createElement(Button, { icon: import_react17.default.createElement(Import, null), text: t("toolbar.download"), minimal: true, loading: p3 }));
});
...
// node_modules/polotno/toolbar/toolbar.js
var A = { text: TextToolbar, image: ImageToolbar, svg: SvgToolbar, many: ManyToolbar, line: LineToolbar, video: VideoToolbar, figure: FigureToolbar, gif: GifToolbar, page: PageToolbar };
...
var G = styled_default("div")`
  ...
  ${mobileStyle("\n    display: flex;\n  ")}
`;
var Toolbar = observer(({ store: t6, downloadButtonEnabled: n2, components: m2 = {} }) => {
  const s3 = 1 === new Set(t6.selectedElements.map((e20) => e20.type)).size, p3 = 1 === t6.selectedElements.length, c2 = t6.selectedElements[0], d2 = t6.selectedElements.every((e20) => e20.styleEditable);
  let u2 = d2 && p3 && A[c2.type];
  s3 ? u2 = A[c2.type] : t6.selectedElements.length > 1 && (u2 = A.many), 0 === t6.selectedElements.length && (u2 = A.page), p3 && "text" === c2.type && flags.htmlRenderEnabled && (u2 = HtmlToolbar);
  const f2 = p3 && c2._cropModeEnabled, b3 = import_react22.default.useRef(m2);
  (Object.keys(m2).some((e20) => m2[e20] !== b3.current[e20]) || Object.keys(b3.current).some((e20) => !(e20 in m2))) && (b3.current = Object.assign({}, m2));
  const j = b3.current, E3 = (null == j ? void 0 : j.ActionControls) || (n2 ? DownloadButton : null), H2 = (null == j ? void 0 : j.Position) || PositionPicker, S = (null == j ? void 0 : j.Opacity) || OpacityPicker, $2 = (null == j ? void 0 : j.Lock) || LockButton, z = (null == j ? void 0 : j.Duplicate) || DuplicateButton, B2 = (null == j ? void 0 : j.Remove) || RemoveButton, D = (null == j ? void 0 : j.Group) || GroupButton, F2 = (null == j ? void 0 : j.History) || HistoryButtons, I2 = (null == j ? void 0 : j.Admin) || AdminButton, L3 = (null == j ? void 0 : j.CopyStyle) || CopyStyleButton;
  return import_react22.default.createElement(C, { className: "bp5-navbar polotno-toolbar" }, import_react22.default.createElement(G, null, !f2 && import_react22.default.createElement(F2, { store: t6 }), u2 && d2 && import_react22.default.createElement(u2, { store: t6, components: j }), !f2 && import_react22.default.createElement(Navbar.Group, { align: Alignment.RIGHT }, "admin" === t6.role && import_react22.default.createElement(I2, { store: t6 }), import_react22.default.createElement(D, { store: t6 }), import_react22.default.createElement(H2, { store: t6 }), d2 && import_react22.default.createElement(S, { store: t6 }), import_react22.default.createElement($2, { store: t6 }), import_react22.default.createElement(z, { store: t6 }), import_react22.default.createElement(B2, { store: t6 }), import_react22.default.createElement(L3, { store: t6 }), E3 && import_react22.default.createElement(import_react22.default.Fragment, null, import_react22.default.createElement(Divider, { style: { height: "100%", margin: "0 15px" } }), import_react22.default.createElement(E3, { store: t6 })))));
});
...
//# sourceMappingURL=chunk-4HBPP2XE.js.map
