  ...
  "node_modules/konva/lib/Util.js"(exports) {
    ...
    var Transform = class _Transform {
      ...
      decompose() {
        ...
        if (a5 != 0 || b != 0) {
          const r5 = Math.sqrt(a5 * a5 + b * b);
          result.rotation = b > 0 ? Math.acos(a5 / r5) : -Math.acos(a5 / r5);
          result.scaleX = r5;
...
var require_Validators = __commonJS({
  "node_modules/konva/lib/Validators.js"(exports) {
    ...
    function getNumberOrAutoValidator() {
      if (Global_1.Konva.isUnminified) {
        return function(val, attr) {
          const isNumber2 = Util_1.Util._isNumber(val);
...
var require_Node = __commonJS({
  "node_modules/konva/lib/Node.js"(exports) {
    ...
    var Node = class _Node {
        ...
        if (filters) {
          if (!this._filterUpToDate) {
            ...
            try {
              ...
              Util_1.Util.error("Unable to apply filter. " + e4.message + " This post my help you https://konvajs.org/docs/posts/Tainted_Canvas.html.");
            }
      ...
      off(evtStr, callback) {
        let events = (evtStr || "").split(SPACE), len = events.length, n5, t7, event, parts, baseEvent, name;
        this._cache && this._cache.delete(ALL_LISTENERS);
        if (!evtStr) {
          for (t7 in this.eventListeners) {
            this._off(t7);
          }
        }
        for (n5 = 0; n5 < len; n5++) {
      ...
      _getTransform() {
        ...
        m2.reset();
        const x = this.x(), y = this.y(), rotation = Global_1.Konva.getAngle(this.rotation()), scaleX = (_a2 = this.attrs.scaleX) !== null && _a2 !== void 0 ? _a2 : 1, scaleY = (_b = this.attrs.scaleY) !== null && _b !== void 0 ? _b : 1, skewX = this.attrs.skewX || 0, skewY = this.attrs.skewY || 0, offsetX = this.attrs.offsetX || 0, offsetY = this.attrs.offsetY || 0;
        if (x !== 0 || y !== 0) {
          m2.translate(x, y);
        }
        if (rotation !== 0) {
      ...
      clone(obj) {
        let attrs = Util_1.Util.cloneObject(this.attrs), key, allListeners, len, n5, listener;
        for (key in obj) {
          attrs[key] = obj[key];
        }
  ...
  "node_modules/konva/lib/Container.js"(exports) {
    ...
    var Container = class extends Node_1.Node {
      ...
      getClientRect(config = {}) {
        ...
        for (let i4 = 0; i4 < shapes.length; i4++) {
    ...
    var Shape = class extends Node_1.Node {
      ...
      drawHitFromCache(alphaThreshold = 0) {
        ...
        try {
          ...
          Util_1.Util.error("Unable to draw hit graph from cached scene canvas. " + e4.message);
        }
        return this;
      }
      hasPointerCapture(pointerId) {
  ...
  "node_modules/konva/lib/Tween.js"(exports) {
    ...
    var TweenEngine = class {
      ...
      getPosition(t7) {
        ...
        return this.func(t7, this.begin, this._change, this.duration);
      }
      play() {
        this.state = PLAYING;
      ...
      onEnterFrame() {
        const t7 = this.getTimer() - this._startTime;
        if (this.state === PLAYING) {
          this.setTime(t7);
        } else if (this.state === REVERSING) {
          this.setTime(this.duration - t7);
        }
      }
      pause() {
        this.state = PAUSED;
          ...
          if (key.indexOf("fill") === 0) {
            for (let n5 = 0; n5 < len; n5++) {
              if (n5 % 2 === 0) {
                ...
                const startRGBA = Util_1.Util.colorToRGBA(start[n5]);
                endRGBA = Util_1.Util.colorToRGBA(end[n5]);
                start[n5] = startRGBA;
                diff.push({
    ...
    exports.Easings = {
      BackEaseIn(t7, b, c4, d2) {
        const s5 = 1.70158;
        return c4 * (t7 /= d2) * t7 * ((s5 + 1) * t7 - s5) + b;
      },
      BackEaseOut(t7, b, c4, d2) {
        const s5 = 1.70158;
        return c4 * ((t7 = t7 / d2 - 1) * t7 * ((s5 + 1) * t7 + s5) + 1) + b;
      },
      BackEaseInOut(t7, b, c4, d2) {
        let s5 = 1.70158;
        if ((t7 /= d2 / 2) < 1) {
          return c4 / 2 * (t7 * t7 * (((s5 *= 1.525) + 1) * t7 - s5)) + b;
        }
        return c4 / 2 * ((t7 -= 2) * t7 * (((s5 *= 1.525) + 1) * t7 + s5) + 2) + b;
      },
      ElasticEaseIn(t7, b, c4, d2, a5, p2) {
        let s5 = 0;
        if (t7 === 0) {
          return b;
        }
        ...
        return -(a5 * Math.pow(2, 10 * (t7 -= 1)) * Math.sin((t7 * d2 - s5) * (2 * Math.PI) / p2)) + b;
      },
      ElasticEaseOut(t7, b, c4, d2, a5, p2) {
        let s5 = 0;
        if (t7 === 0) {
          return b;
        }
        ...
        return a5 * Math.pow(2, -10 * t7) * Math.sin((t7 * d2 - s5) * (2 * Math.PI) / p2) + c4 + b;
      },
      ElasticEaseInOut(t7, b, c4, d2, a5, p2) {
        let s5 = 0;
        if (t7 === 0) {
          return b;
        }
        ...
        if (t7 < 1) {
          return -0.5 * (a5 * Math.pow(2, 10 * (t7 -= 1)) * Math.sin((t7 * d2 - s5) * (2 * Math.PI) / p2)) + b;
        }
        return a5 * Math.pow(2, -10 * (t7 -= 1)) * Math.sin((t7 * d2 - s5) * (2 * Math.PI) / p2) * 0.5 + c4 + b;
      },
      BounceEaseOut(t7, b, c4, d2) {
        if ((t7 /= d2) < 1 / 2.75) {
          return c4 * (7.5625 * t7 * t7) + b;
        } else if (t7 < 2 / 2.75) {
          return c4 * (7.5625 * (t7 -= 1.5 / 2.75) * t7 + 0.75) + b;
        } else if (t7 < 2.5 / 2.75) {
          return c4 * (7.5625 * (t7 -= 2.25 / 2.75) * t7 + 0.9375) + b;
        } else {
          return c4 * (7.5625 * (t7 -= 2.625 / 2.75) * t7 + 0.984375) + b;
        }
      },
      BounceEaseIn(t7, b, c4, d2) {
        return c4 - exports.Easings.BounceEaseOut(d2 - t7, 0, c4, d2) + b;
      },
      BounceEaseInOut(t7, b, c4, d2) {
        if (t7 < d2 / 2) {
          return exports.Easings.BounceEaseIn(t7 * 2, 0, c4, d2) * 0.5 + b;
        } else {
          return exports.Easings.BounceEaseOut(t7 * 2 - d2, 0, c4, d2) * 0.5 + c4 * 0.5 + b;
        }
      },
      EaseIn(t7, b, c4, d2) {
        return c4 * (t7 /= d2) * t7 + b;
      },
      EaseOut(t7, b, c4, d2) {
        return -c4 * (t7 /= d2) * (t7 - 2) + b;
      },
      EaseInOut(t7, b, c4, d2) {
        if ((t7 /= d2 / 2) < 1) {
          return c4 / 2 * t7 * t7 + b;
        }
        return -c4 / 2 * (--t7 * (t7 - 2) - 1) + b;
      },
      StrongEaseIn(t7, b, c4, d2) {
        return c4 * (t7 /= d2) * t7 * t7 * t7 * t7 + b;
      },
      StrongEaseOut(t7, b, c4, d2) {
        return c4 * ((t7 = t7 / d2 - 1) * t7 * t7 * t7 * t7 + 1) + b;
      },
      StrongEaseInOut(t7, b, c4, d2) {
        if ((t7 /= d2 / 2) < 1) {
          return c4 / 2 * t7 * t7 * t7 * t7 * t7 + b;
        }
        return c4 / 2 * ((t7 -= 2) * t7 * t7 * t7 * t7 + 2) + b;
      },
      Linear(t7, b, c4, d2) {
        return c4 * t7 / d2 + b;
      }
...
var require_Line = __commonJS({
  "node_modules/konva/lib/shapes/Line.js"(exports) {
    ...
    var Shape_1 = require_Shape();
    var Validators_1 = require_Validators();
    function getControlPoints(x0, y0, x1, y1, x2, y2, t7) {
      const d01 = Math.sqrt(Math.pow(x1 - x0, 2) + Math.pow(y1 - y0, 2)), d12 = Math.sqrt(Math.pow(x2 - x1, 2) + Math.pow(y2 - y1, 2)), fa = t7 * d01 / (d01 + d12), fb = t7 * d12 / (d01 + d12), p1x = x1 - fa * (x2 - x0), p1y = y1 - fa * (y2 - y0), p2x = x1 + fb * (x2 - x0), p2y = y1 + fb * (y2 - y0);
...
var require_BezierFunctions = __commonJS({
  "node_modules/konva/lib/BezierFunctions.js"(exports) {
    ...
    var getCubicArcLength = (xs, ys, t7) => {
      let sum;
      let correctedT;
      const n5 = 20;
      const z = t7 / 2;
      ...
      for (let i4 = 0; i4 < n5; i4++) {
        correctedT = z * exports.tValues[n5][i4] + z;
        sum += exports.cValues[n5][i4] * BFunc(xs, ys, correctedT);
      }
      return z * sum;
    };
    exports.getCubicArcLength = getCubicArcLength;
    var getQuadraticArcLength = (xs, ys, t7) => {
      if (t7 === void 0) {
        t7 = 1;
      }
      ...
      const C = bx * bx + by * by;
      if (A === 0) {
        return t7 * Math.sqrt(Math.pow(xs[2] - xs[0], 2) + Math.pow(ys[2] - ys[0], 2));
      }
      const b = B / (2 * A);
      const c4 = C / A;
      const u2 = t7 + b;
    ...
    function BFunc(xs, ys, t7) {
      const xbase = getDerivative(1, t7, xs);
      const ybase = getDerivative(1, t7, ys);
      const combined = xbase * xbase + ybase * ybase;
      return Math.sqrt(combined);
    }
    var getDerivative = (derivative, t7, vs) => {
      ...
      if (derivative === 0) {
        value = 0;
        for (let k = 0; k <= n5; k++) {
          value += exports.binomialCoefficients[n5][k] * Math.pow(1 - t7, n5 - k) * Math.pow(t7, k) * vs[k];
        }
        return value;
      } else {
        _vs = new Array(n5);
        ...
        return getDerivative(derivative - 1, t7, _vs);
      }
    };
    var t2length = (length, totalLength, func) => {
      let error = 1;
      let t7 = length / totalLength;
      let step = (length - func(t7)) / totalLength;
      let numIterations = 0;
      while (error > 1e-3) {
        const increasedTLength = func(t7 + step);
        const increasedTError = Math.abs(length - increasedTLength) / totalLength;
        if (increasedTError < error) {
          error = increasedTError;
          t7 += step;
        } else {
          const decreasedTLength = func(t7 - step);
    ...
    var Path = class _Path extends Shape_1.Shape {
      ...
      getSelfRect() {
        ...
        this.dataArray.forEach(function(data) {
          if (data.command === "A") {
            ...
            if (dTheta < 0) {
              for (let t7 = start - inc; t7 > end; t7 -= inc) {
                const point = _Path.getPointOnEllipticalArc(data.points[0], data.points[1], data.points[2], data.points[3], t7, 0);
            ...
            for (let t7 = 0; t7 <= 1; t7 += 0.01) {
              const point = _Path.getPointOnCubicBezier(t7, data.start.x, data.start.y, data.points[0], data.points[1], data.points[2], data.points[3], data.points[4], data.points[5]);
              points.push(point.x, point.y);
            }
          } else {
      ...
      static getPointAtLengthOfDataArray(length, dataArray) {
        ...
        switch (cp.command) {
          ...
          case "C":
            return _Path.getPointOnCubicBezier((0, BezierFunctions_1.t2length)(length, _Path.getPathLength(dataArray), (i5) => {
              return (0, BezierFunctions_1.getCubicArcLength)([cp.start.x, p2[0], p2[2], p2[4]], [cp.start.y, p2[1], p2[3], p2[5]], i5);
            }), cp.start.x, cp.start.y, p2[0], p2[1], p2[2], p2[3], p2[4], p2[5]);
          case "Q":
            return _Path.getPointOnQuadraticBezier((0, BezierFunctions_1.t2length)(length, _Path.getPathLength(dataArray), (i5) => {
              return (0, BezierFunctions_1.getQuadraticArcLength)([cp.start.x, p2[0], p2[2]], [cp.start.y, p2[1], p2[3]], i5);
      ...
      static getPointOnCubicBezier(pct, P1x, P1y, P2x, P2y, P3x, P3y, P4x, P4y) {
        ...
        function CB3(t7) {
          return 3 * t7 * (1 - t7) * (1 - t7);
        }
        function CB4(t7) {
          return (1 - t7) * (1 - t7) * (1 - t7);
        }
      ...
      static calcLength(x, y, cmd, points) {
        ...
        switch (cmd) {
          ...
          case "A":
            ...
            if (dTheta < 0) {
              for (t7 = start - inc; t7 > end; t7 -= inc) {
                p2 = path.getPointOnEllipticalArc(points[0], points[1], points[2], points[3], t7, 0);
  ...
  "node_modules/konva/lib/shapes/Text.js"(exports) {
    ...
    var Text = class extends Shape_1.Shape {
      constructor(config) {
        ...
        for (let n5 = 0; n5 < attrChangeListLen; n5++) {
          this.on(ATTR_CHANGE_LIST[n5] + CHANGE_KONVA, this._setTextData);
        }
        this._setTextData();
      }
      _sceneFunc(context) {
    ...
    var TextPath = class extends Shape_1.Shape {
      ...
      _setTextData() {
        ...
        for (let i4 = 0; i4 < charArr.length; i4++) {
          ...
          if (!charStartPoint)
            return;
          let glyphWidth = this._getTextSize(charArr[i4]).width + letterSpacing;
          if (charArr[i4] === " " && align === "justify") {
          ...
          if (kerningFunc) {
            try {
              kern = kerningFunc(charArr[i4 - 1], charArr[i4]) * this.fontSize();
            } catch (e4) {
              kern = 0;
            }
          }
...
var require_Transformer = __commonJS({
  "node_modules/konva/lib/shapes/Transformer.js"(exports) {
    ...
    function rotateAroundPoint2(shape, angleRad, point) {
    ...
    function rotateAroundCenter2(shape, deltaRad) {
      const center = getCenter2(shape);
      return rotateAroundPoint2(shape, deltaRad, center);
    }
    function getSnap(snaps, newRotationRad, tol) {
      let snapped = newRotationRad;
      for (let i4 = 0; i4 < snaps.length; i4++) {
        const angle = Global_1.Konva.getAngle(snaps[i4]);
    ...
    var Transformer = class extends Group_1.Group {
      ...
      setNodes(nodes = []) {
        ...
        this._nodes.forEach((node) => {
          ...
          node.on(TRANSFORM_CHANGE_STR.map((e4) => e4 + `.${this._getEventNamespace()}`).join(" "), onChange);
      ...
      __getNodeShape(node, rot = this.rotation(), relative) {
        ...
        return rotateAroundPoint2(box, -Global_1.Konva.getAngle(rot), {
          x: 0,
          y: 0
        });
      }
      ...
      _handleMouseMove(e4) {
        ...
        if (this._movingAnchorName === "rotater") {
          ...
          const shape = rotateAroundCenter2(attrs, diff);
      ...
      _fitNodesInto(newAttrs, evt) {
        ...
        const t7 = new Util_1.Transform();
        t7.rotate(Global_1.Konva.getAngle(this.rotation()));
        if (this._movingAnchorName && newAttrs.width < 0 && this._movingAnchorName.indexOf("left") >= 0) {
          const offset = t7.point({
            x: -this.padding() * 2,
            y: 0
          });
          newAttrs.x += offset.x;
    ...
    var Emboss = function(imageData) {
      ...
      do {
        ...
        do {
          ...
          dif *= strength;
          if (blend) {
            const r5 = data[offset] + dif;
            const g = data[offset + 1] + dif;
            const b = data[offset + 2] + dif;
            data[offset] = r5 > 255 ? 255 : r5 < 0 ? 0 : r5;
...
var require_Enhance = __commonJS({
  "node_modules/konva/lib/filters/Enhance.js"(exports) {
    ...
    var Enhance = function(imageData) {
      ...
      let rMin = data[0], rMax = rMin, r5, gMin = data[1], gMax = gMin, g, bMin = data[2], bMax = bMin, b;
  ...
  "node_modules/konva/lib/filters/HSL.js"(exports) {
    ...
    var HSL = function(imageData) {
      ...
      for (let i4 = 0; i4 < nPixels; i4 += 4) {
        ...
        b = data[i4 + 2];
        a5 = data[i4 + 3];
        data[i4 + 0] = rr * r5 + rg * g + rb * b + l4;
        data[i4 + 1] = gr * r5 + gg * g + gb * b + l4;
        data[i4 + 2] = br * r5 + bg * g + bb * b + l4;
        data[i4 + 3] = a5;
      }
    };
    exports.HSL = HSL;
  ...
  "node_modules/konva/lib/filters/HSV.js"(exports) {
    ...
    var HSV = function(imageData) {
      ...
      for (let i4 = 0; i4 < nPixels; i4 += 4) {
        ...
        const b = data[i4 + 2];
        const a5 = data[i4 + 3];
        data[i4 + 0] = rr * r5 + rg * g + rb * b;
        data[i4 + 1] = gr * r5 + gg * g + gb * b;
        data[i4 + 2] = br * r5 + bg * g + bb * b;
        data[i4 + 3] = a5;
      }
    };
    exports.HSV = HSV;
...
var require_Kaleidoscope = __commonJS({
  "node_modules/konva/lib/filters/Kaleidoscope.js"(exports) {
    ...
    var Kaleidoscope = function(imageData) {
      ...
      let x, y, xoff, i4, r5, g, b, a5, srcPos, dstPos;
  ...
  "node_modules/konva/lib/filters/Sepia.js"(exports) {
    ...
    var Sepia = function(imageData) {
      ...
      for (let i4 = 0; i4 < nPixels; i4 += 4) {
        ...
        const g = data[i4 + 1];
        const b = data[i4 + 2];
        data[i4 + 0] = Math.min(255, r5 * 0.393 + g * 0.769 + b * 0.189);
        data[i4 + 1] = Math.min(255, r5 * 0.349 + g * 0.686 + b * 0.168);
        data[i4 + 2] = Math.min(255, r5 * 0.272 + g * 0.534 + b * 0.131);
      }
    };
    exports.Sepia = Sepia;
  }
...
var e = false;
var toggleFadeInAnimation = (t7 = !e) => {
  e = t7;
};
...
function useFadeIn(n5, o3) {
  ...
  import_react.default.useLayoutEffect(() => {
    ...
    const t7 = n5.current.opacity();
    return t7 ? (n5.current.opacity(0), c4.current = new import_konva.default.Tween({ node: n5.current, opacity: t7, onFinish: () => {
      var t8;
      null === (t8 = c4.current) || void 0 === t8 || t8.destroy();
    } }), c4.current.play(), () => {
      var t8;
      null === (t8 = c4.current) || void 0 === t8 || t8.destroy();
    }) : void 0;
...
var t2 = [];
var r2 = 3e4;
var setAssetLoadTimeout = (e4) => {
  r2 = e4;
};
var n = 6e3;
var setFontLoadTimeout = (e4) => {
  n = e4;
};
var getFontLoadTimeout = () => n;
function incrementLoader(e4) {
  o += 1;
  let t7 = false, n5 = false;
  const a5 = setTimeout(() => {
    t7 || (triggerLoadError(`Timeout loading asset ${e4}`), console.error("Timeout triggered for loader. Some assets may not have loaded.", e4), t7 = true, decrementLoader());
  }, r2);
  return () => {
    n5 ? console.error("Finish called twice! That is not expected. id: ", e4) : (n5 = true, t7 || (clearTimeout(a5), decrementLoader()));
  };
}
...
function whenLoaded() {
  return new Promise((r5) => {
    return n5 = () => {
      isAnimationUsed() ? setTimeout(r5, 300) : r5(true);
    }, void (0 === o ? n5() : t2.push(n5));
    var n5;
  });
}
var a = [];
function onLoadError(e4) {
  a.push(e4);
}
...
function setGoogleFonts(t7) {
  "default" !== t7 ? (l.value = true, n2.splice(0, n2.length), n2.push(...t7)) : l.value = false;
}
function getFontsList() {
  return n2;
}
var globalFonts = observable([]);
function addGlobalFont(t7) {
  globalFonts.push(t7);
}
function removeGlobalFont(t7) {
  const o3 = globalFonts.findIndex((o4) => o4.fontFamily === t7);
  -1 !== o3 && globalFonts.splice(o3, 1);
}
function replaceGlobalFonts(t7) {
  globalFonts.replace(t7);
}
var r3 = "Some test text;?#D-ПРИВЕТ!1230o9u8i7y6t5r4e3w2q1";
var i;
function a2(t7, o3 = "Arial", e4 = "normal", n5 = "normal") {
  i || (i = document.createElement("canvas"));
  var l4 = i.getContext("2d");
  return l4.font = `${e4} ${n5} 40px '${t7}', ${o3}`, l4.measureText(r3).width;
}
var s = { Arial: true };
var isFontLoaded = (t7) => !!s[t7];
async function loadFont(t7, n5, l4) {
  var r5;
  if (s[t7]) {
    return;
  }
  const i4 = !!(null === (r5 = document.fonts) || void 0 === r5 ? void 0 : r5.load), c4 = a2("Arial", "Arial", n5, l4);
  if (i4) {
    try {
      await document.fonts.load(`16px '${t7}', ${n5} ${l4}`);
      if (c4 !== a2(t7, "Arial", n5, l4)) {
        return void (s[t7] = true);
      }
    } catch (d2) {
    }
  }
  const u2 = a2("Times", "Times", n5, l4), f2 = a2(t7, "Arial", n5, l4), m2 = Math.min(6e3, getFontLoadTimeout()) / 60;
  for (let o3 = 0; o3 < m2; o3++) {
    const o4 = a2(t7, "Arial", n5, l4), e4 = a2(t7, "Times", n5, l4);
    if (o4 !== f2 || o4 !== c4 || e4 !== u2) {
      return void (s[t7] = true);
    }
    await new Promise((t8) => setTimeout(t8, 60));
  }
  console.warn(`Timeout for loading font "${t7}". Looks like polotno can't load it. Is it a correct font family?`), triggerLoadError(`Timeout for loading font "${t7}"`);
}
var c = {};
var u = "400,400italic,700,700italic";
function setGoogleFontsVariants(t7) {
  u = t7;
}
function getGoogleFontsVariants() {
  return u;
}
function getGoogleFontsUrl(t7) {
  return `https://fonts.googleapis.com/css?family=${t7.replace(/ /g, "+")}:${u}`;
}
function injectGoogleFont(t7) {
  if (c[t7]) {
    return;
  }
  const o3 = getGoogleFontsUrl(t7), e4 = document.createElement("link");
  e4.type = "text/css", e4.href = o3, e4.rel = "stylesheet", document.getElementsByTagName("head")[0].appendChild(e4), c[t7] = true;
}
var f = {};
var m;
function injectCustomFont(t7) {
  const o3 = t7.fontFamily;
  if (f[o3]) {
    return;
  }
  if (!t7.url && !t7.styles) {
  ...
  const e4 = t7.styles || (t7.url ? [{ src: `url("${t7.url}")` }] : []), n5 = (m || (m = document.getElementById("polotno-font-style"), m || (m = document.createElement("style"), m.id = "polotno-font-style", document.head.appendChild(m)), m)).sheet;
  e4.forEach((t8) => {
    n5.insertRule(`
    @font-face{
      font-family:'${o3}';
      src:${t8.src};
      font-style:${t8.fontStyle || "normal"};
      font-weight:${t8.fontWeight || "normal"};
      font-display:swap;   /* optional but recommended */
    }`, n5.cssRules.length);
  }), f[t7.fontFamily] = true;
}
...
var URLS = { unsplashList: ({ query: t7, page: e4 = 1 }) => `${getAPI()}/get-unsplash?query=${t7}&per_page=20&page=${e4}&KEY=${getKey()}`, unsplashDownload: (t7) => `${getAPI()}/download-unsplash?id=${t7}&KEY=${getKey()}`, svgapiList: ({ query: t7, page: e4 = 0 }) => `${getAPI()}/get-svgapi?query=${t7}&page=${e4}&per_page=20&KEY=${getKey()}`, svgapiDownload: (t7) => `${getAPI()}/download-svgapi?path=${t7}&KEY=${getKey()}`, iconscoutList: ({ query: t7, page: n5 = 1 }) => (e2("iconscout", s2), `${getAPI()}/get-iconscout?query=${t7}&page=${n5}&KEY=${getKey()}`), iconscoutDownload: (t7) => (e2("iconscout", s2), `${getAPI()}/download-iconscout?uuid=${t7}&KEY=${getKey()}`), nounProjectList: ({ query: t7, page: e4 = 1 }) => `${getAPI()}/get-nounproject?query=${t7}&page=${e4}&KEY=${getKey()}`, nounProjectDownload: (t7) => `${getAPI()}/download-nounproject?id=${t7}&KEY=${getKey()}`, templateList: ({ query: t7, page: e4 = 1, sizeQuery: s5 }) => `${getAPI()}/get-templates?${s5}&query=${t7}&per_page=30&page=${e4}&KEY=${getKey()}`, googleFontsList: () => `${getAPI()}/get-google-fonts?KEY=${getKey()}`, googleFontImage: (o3) => {
  return `${URL}/google-fonts-previews/black/${t7 = o3, t7.replace(new RegExp(" ", "g"), "-")}.png`;
  var t7;
...
async function isKeyPaid(n5) {
  for (let r5 = 0; r5 < 5; r5++) {
    try {
      const i4 = await p(getAPI() + "/validate-key", { method: "POST", body: JSON.stringify({ key: n5, site: location.host, skdVersion: "2.25.11" }) });
      if (runInAction(() => {
      ...
      const r6 = await i4.json();
      return r6.is_valid || console.warn("Polotno API key is not valid. Please get new API key here: https://polotno.com/cabinet"), r6.is_paid || console.log("%cPolotno Free Version. For development usage only. https://polotno.com/", "background: rgb(0, 161, 255); color: white; padding: 5px; margin: 5px;"), r6.is_domain_valid || console.log(c2, "background: rgba(247, 101, 68, 1); color: white; padding: 5px; margin: 5px;"), useRemoveBackground(r6.remove_background_enabled), r6.is_paid || false;
    } catch (i4) {
      await new Promise((e4) => setTimeout(e4, 3e3));
    }
  }
...
async function validateKey(e4, o3) {
  r4 = e4, await isKeyPaid(e4) && !o3 || i2();
}
...
function __read(o3, n5) {
  ...
  if (!m2)
    return o3;
  var i4 = m2.call(o3), r5, ar = [], e4;
  try {
    while ((n5 === void 0 || n5-- > 0) && !(r5 = i4.next()).done)
      ar.push(r5.value);
  } catch (error) {
    e4 = { error };
  } finally {
    ...
    Object.defineProperty(Union2.prototype, "determineType", {
      ...
      value: function(value, reconcileCurrentType) {
        ...
        if (reconcileCurrentType) {
          ...
          return this._types.filter(function(t7) {
            return t7 !== reconcileCurrentType;
          }).find(function(type) {
...
var Late = (
  ...
  function(_super) {
    ...
    Object.defineProperty(Late2.prototype, "describe", {
      ...
      writable: true,
      value: function() {
        var t7 = this.getSubType(false);
        return t7 ? t7.name : "<uknown late type>";
      }
    });
    Object.defineProperty(Late2.prototype, "isValidSnapshot", {
      ...
      value: function(value, context) {
        ...
        return t7.validate(value, context);
      }
    });
    Object.defineProperty(Late2.prototype, "isAssignableFrom", {
      ...
      value: function(type) {
        var t7 = this.getSubType(false);
        return t7 ? t7.isAssignableFrom(type) : false;
      }
    });
...
var parseColor = (e4) => {
  ...
  const r5 = import_gradient_parser.default.parse(e4)[0];
  return { rotation: parseFloat(r5.orientation.value), stops: r5.colorStops.map((o3, e5) => ({ color: t4(o3), offset: o3.length ? parseFloat(o3.length.value) / 100 : e5 / (r5.colorStops.length - 1) })) };
};
...
function l3(t7) {
  const e4 = {};
  return t7.querySelectorAll("style").forEach((t8) => {
    const r5 = import_mensch.default.parse(t8.textContent).stylesheet.rules;
    for (let o3 of r5) {
      o3.selectors && o3.selectors.forEach((t9) => {
        const r6 = e4[t9] || {};
        o3.declarations.forEach((t10) => {
          r6[t10.name] = t10.value;
        }), e4[t9] = r6;
      });
    }
  }), e4;
...
function i3(t7, e4) {
  var r5;
  const o3 = { fill: "", stroke: "" }, n5 = (null === (r5 = t7.getAttribute("class")) || void 0 === r5 ? void 0 : r5.split(" ")) || [], s5 = t7.getAttribute("id");
  let l4 = {};
  if (s5 && e4[`#${s5}`] ? l4 = e4[`#${s5}`] : n5.forEach((t8) => {
    e4[`.${t8}`] && (l4 = Object.assign(Object.assign({}, l4), e4[`.${t8}`]));
  }), e4[t7.nodeName] && (l4 = Object.assign(Object.assign({}, l4), e4[t7.nodeName])), t7.getAttribute("fill") && "none" !== t7.getAttribute("fill") ? o3.fill = t7.getAttribute("fill") : l4.fill && "none" !== l4.fill && (o3.fill = l4.fill), t7.getAttribute("stroke") && "none" !== t7.getAttribute("stroke") ? o3.stroke = t7.getAttribute("stroke") : l4.stroke && "none" !== l4.stroke && (o3.stroke = l4.stroke), !o3.fill && t7.style.fill && "none" !== t7.style.fill && (o3.fill = t7.style.fill), !o3.stroke && t7.style.stroke && "none" !== t7.style.stroke && (o3.stroke = t7.style.stroke), !o3.stroke && !o3.fill) {
    const r6 = t7.ownerSVGElement, n6 = r6 && r6 !== t7 && i3(r6, e4);
...
function c3(t7) {
  for (var e4 = [], r5 = t7.getElementsByTagName("*"), o3 = 0, n5 = r5.length; o3 < n5; o3++) {
    const t8 = r5[o3];
    s4(t8) || (null !== t8.getAttribute("fill") && e4.push(t8), (null !== t8.getAttribute("stroke") || t8.style && t8.style.fill || a4.indexOf(t8.nodeName) >= 0) && e4.push(t8));
  }
  return e4;
}
async function urlToBase64(t7) {
  const e4 = await fetch(t7);
  return svgToURL(await e4.text());
}
async function urlToString(t7) {
  const e4 = await fetch(t7, { mode: "cors" });
  return await e4.text();
}
function getColors(e4) {
  var r5 = new DOMParser().parseFromString(e4, "image/svg+xml");
  const o3 = l3(r5), n5 = c3(r5), s5 = [];
  return n5.forEach((e5) => {
    const { fill: r6, stroke: n6 } = i3(e5, o3);
    [r6, n6].forEach((e6) => {
      e6 && ("currentColor" === e6 && (e6 = "black"), import_konva2.default.Util.colorToRGBA(e6) && -1 === s5.indexOf(e6) && s5.push(e6));
    });
  }), s5;
}
function svgToURL(t7) {
  return "data:image/svg+xml;base64," + window.btoa(unescape(encodeURIComponent(t7)));
}
async function getSvgSize(t7) {
  const e4 = await urlToString(t7), r5 = new DOMParser().parseFromString(e4, "image/svg+xml").documentElement.getAttribute("viewBox"), [o3, n5, s5, l4] = (null == r5 ? void 0 : r5.split(" ")) || [];
  return { width: parseFloat(s5), height: parseFloat(l4) };
}
function fixSize(t7) {
  var e4 = new DOMParser().parseFromString(t7, "image/svg+xml");
  const r5 = e4.documentElement.getAttribute("viewBox"), [o3, n5, s5, l4] = (null == r5 ? void 0 : r5.split(" ")) || [], i4 = e4.documentElement.getAttribute("width");
  ...
  if ((!a5 || a5.indexOf("%") >= 0) && e4.documentElement.setAttribute("height", l4 + "px"), i4 && i4.indexOf("%") >= 0 && a5 && -1 === a5.indexOf("%")) {
    const t8 = parseFloat(a5) / parseFloat(l4);
    e4.documentElement.setAttribute("width", t8 * parseFloat(s5) + "px");
  }
  if (a5 && a5.indexOf("%") >= 0 && i4 && -1 === i4.indexOf("%")) {
    const t8 = parseFloat(i4) / parseFloat(s5);
    e4.documentElement.setAttribute("height", t8 * parseFloat(l4) + "px");
  }
...
var sameColors = (e4, r5) => {
  if (!e4 || !r5) {
    return false;
  }
  if ("currentColor" === r5 && "black" === e4) {
    return true;
  }
  const o3 = import_konva2.default.Util.colorToRGBA(e4), n5 = import_konva2.default.Util.colorToRGBA(r5);
...
function replaceColors(e4, n5) {
  ...
  return a5.forEach((e5) => {
    ...
    [{ prop: "fill", color: l4 }, { prop: "stroke", color: a6 }].forEach(({ prop: l5, color: i4 }) => {
      const a7 = u2.find((t7) => sameColors(t7, i4));
      if (a7) {
        const i5 = n5.get(a7);
        if (isGradient(i5)) {
          const { rotation: o3, stops: n6 } = parseColor(i5), a8 = n6.map((t7) => ({ offset: 100 * t7.offset + "%", "stop-color": t7.color })), c4 = "color" + Math.round(1e8 * Math.random());
          !function(e6, r5, o4, n7) {
            var s6 = e6.namespaceURI, l6 = document.createElementNS(s6, "linearGradient");
            const i6 = import_konva2.default.Util.degToRad(o4 + 90), a9 = (Math.cos(i6) + 1) / 2, c5 = (Math.sin(i6) + 1) / 2, u3 = (Math.cos(i6 + Math.PI) + 1) / 2, f3 = (Math.sin(i6 + Math.PI) + 1) / 2;
            l6.setAttribute("x1", 100 * a9 + "%"), l6.setAttribute("y1", 100 * c5 + "%"), l6.setAttribute("x2", 100 * u3 + "%"), l6.setAttribute("y2", 100 * f3 + "%"), l6.setAttribute("gradientUnits", "userSpaceOnUse"), l6.setAttribute("id", r5);
...
var useSvgColors = (t7) => {
  const [r5, o3] = import_react2.default.useState([]);
  return import_react2.default.useEffect(() => {
    let e4 = false;
    return (async () => {
      o3([]);
      const r6 = getColors(await urlToString(t7));
      e4 || o3(r6);
    })(), () => {
      e4 = true;
    };
...
function removeTags(e4 = "") {
  return (e4.match(/<\/p>/gi) || []).length > 1 && (e4 = e4.replace(/<\/p>/gi, (e5, t7, a5) => (a5.slice(t7 + e5.length).match(/<\/p>/gi) || []).length > 0 ? "\n" : e5)), e4.replace(/(<([^>]+)>)/gi, "");
}
...
function loadImage(t7) {
  return new Promise((e4, h) => {
    ...
    i4.onload = () => {
      ...
      h(t8);
    }, i4.crossOrigin = "anonymous", i4.src = t7;
  });
}
async function cropImage(t7, e4) {
  const h = await loadImage(t7), i4 = document.createElement("canvas");
  ...
  let { cropX: r5, cropY: g } = e4;
  const c4 = i4.width * e4.cropWidth, d2 = i4.height * e4.cropHeight, a5 = e4.width / e4.height;
  let s5, w;
  const m2 = c4 / d2;
  return "svg" === e4.type ? (s5 = c4, w = d2) : a5 >= m2 ? (s5 = c4, w = c4 / a5) : (s5 = d2 * a5, w = d2), n5.drawImage(i4, r5 * i4.width, g * i4.height, s5, w, 0, 0, o3.width, o3.height), o3.toDataURL("image/png");
}
function getCrop(t7, e4) {
  const { width: h, height: i4 } = t7, o3 = h / i4;
  let n5, r5;
  o3 >= e4.width / e4.height ? (n5 = e4.width, r5 = e4.width / o3) : (n5 = e4.height * o3, r5 = e4.height);
  const g = (e4.width - n5) / 2, c4 = (e4.height - r5) / 2;
  return { cropX: g / e4.width, cropY: c4 / e4.height, cropWidth: n5 / e4.width, cropHeight: r5 / e4.height };
}

// node_modules/polotno/utils/math.js
function degToRad(t7) {
  return t7 / 180 * Math.PI;
}
function t6(t7, n5, a5, e4, o3) {
  const i4 = Math.sqrt(a5 * a5 + e4 * e4);
  return o3 += Math.atan2(e4, a5), { x: t7 + i4 * Math.cos(o3), y: n5 + i4 * Math.sin(o3) };
}
function getClientRect(n5) {
  const { x: a5, y: e4, width: o3, height: i4 } = n5, h = degToRad(n5.rotation), x = t6(a5, e4, 0, 0, h), r5 = t6(a5, e4, o3, 0, h), m2 = t6(a5, e4, o3, i4, h), c4 = t6(a5, e4, 0, i4, h), M = Math.min(x.x, r5.x, m2.x, c4.x), s5 = Math.min(x.y, r5.y, m2.y, c4.y), y = Math.max(x.x, r5.x, m2.x, c4.x), u2 = Math.max(x.y, r5.y, m2.y, c4.y);
  return { x: M, y: s5, width: y - M, height: u2 - s5, minX: M, minY: s5, maxX: y, maxY: u2 };
}
function getTotalClientRect(t7) {
  const n5 = t7.map((t8) => getClientRect(t8)), a5 = Math.min(...n5.map((t8) => t8.minX)), e4 = Math.min(...n5.map((t8) => t8.minY)), o3 = Math.max(...n5.map((t8) => t8.maxX)), i4 = Math.max(...n5.map((t8) => t8.maxY));
  return { x: a5, y: e4, width: o3 - a5, height: i4 - e4, minX: a5, minY: e4, maxX: o3, maxY: i4 };
}
function getCenter(t7) {
  const n5 = degToRad(t7.rotation || 0);
  return { x: t7.x + t7.width / 2 * Math.cos(n5) + t7.height / 2 * Math.sin(-n5), y: t7.y + t7.height / 2 * Math.cos(n5) + t7.width / 2 * Math.sin(n5) };
}
function rotateAroundPoint(t7, n5, a5) {
  const e4 = degToRad(n5), o3 = a5.x + (t7.x - a5.x) * Math.cos(e4) - (t7.y - a5.y) * Math.sin(e4), i4 = a5.y + (t7.x - a5.x) * Math.sin(e4) + (t7.y - a5.y) * Math.cos(e4);
  return Object.assign(Object.assign({}, t7), { rotation: t7.rotation + n5, x: o3, y: i4 });
}
function rotateAroundCenter(t7, n5) {
  return rotateAroundPoint(t7, n5, getCenter(t7));
}

// node_modules/polotno/utils/video.js
async function getVideoSize(e4) {
  return new Promise((t7, n5) => {
    const r5 = document.createElement("video");
    r5.crossOrigin = "anonymous", r5.src = e4, r5.addEventListener("loadedmetadata", () => {
      const { videoWidth: e5, videoHeight: n6 } = r5;
      t7({ width: e5, height: n6 });
    }), r5.addEventListener("error", (t8) => {
      const r6 = e4.slice(0, 100);
      n5(new Error(`Failed to load video: ${r6}`));
    });
  });
}
...
async function getVideoPreview(e4, t7 = 5) {
  return new Promise((n5, r5) => {
    ...
    o3.crossOrigin = "anonymous", o3.src = e4, o3.addEventListener("error", (e5) => {
      ...
      i4.width = 480, i4.height = 480 / e5, o3.currentTime = t7;
...
async function getVideoObjectPreview(e4, t7, n5) {
  return new Promise((r5, o3) => {
    const i4 = t7.getContext("2d"), d2 = () => {
      try {
        i4.drawImage(e4, 0, 0, t7.width, t7.height);
        const n6 = t7.toDataURL();
        r5(n6), e4.removeEventListener("seeked", d2);
      } catch (n6) {
...
//# sourceMappingURL=chunk-UKEGL2ZK.js.map
