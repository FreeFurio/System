...
import { FiImage, FiClock, FiCheckCircle, FiTrendingUp, FiActivity, FiCalendar } from 'react-icons/fi';
  ...
  return (
    <div style={componentStyles.pageContainer}>
      ...
      <div style={{
        ...
        }}>Graphic Designer Dashboard</h1>
        <p style={{
          margin: '8px 0 0 0',
          color: '#6b7280',
          fontSize: '16px',
          fontWeight: '400'
        }}>Create stunning visuals and manage your design projects</p>
      </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: '0.75rem', color: '#6b7280' }}>
                    {
                      task.status === 'assigned' ? 'Ready to design' :
